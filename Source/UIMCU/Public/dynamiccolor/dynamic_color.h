...
#include "cam/hct.h"
#include "dynamiccolor/contrast_curve.h"
#include "dynamiccolor/dynamic_scheme.h"
#include "utils/utils.h"

namespace material_color_utilities {

struct UIMCU_API ToneDeltaPair;
 ...
 * construct UIMCU_APIed.
 */
struct UIMCU_API DynamicColor {
  std::string name_;
  ...
  /** A convenience construct UIMCU_APIor, only requiring name, palette, and tone. */
  ...
  /** The default construct UIMCU_APIor. */
